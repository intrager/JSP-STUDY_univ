                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="../writers/update-form.do" method="post">
                                ...
                                <hr>
                                <a href="../writers/delete.do?id=${requestScope.writer.id}" class="btn btn-primary btn-user btn-block">회원 탈퇴</a>
<%--                                <hr>--%>
